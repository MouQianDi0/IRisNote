...
export default function NoteViewerTitle({
    ...
    const visibleHeight =
        isTitleExpandable && !titleExpanded
        ...
        <>
            ...
            >
                <Text
                    ...
                    numberOfLines={3}
                    onLayout={(event) =>
                        updateHeight(event, setCollapsedTitleHeight)
                    }
                >
                    {title || " "}
                </Text>
                <Text
                    className="text-2xl font-bold text-gray-900"
                    onLayout={(event) =>
                        updateHeight(event, setExpandedTitleHeight)
                    }
                >
                    {title || " "}
                </Text>
            ...
            <View
                style={
                    visibleHeight > 0
                        ? { height: visibleHeight, overflow: "hidden" }
                        : undefined
                }
            >
                <TextInput
