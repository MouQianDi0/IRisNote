...
export const dialogScrim = "flex-1 items-center justify-center bg-hyper-scrim p-6";
export const dialogCard = "w-full max-w-[440px] max-h-[85%] rounded-hyper-modal bg-white p-6";
...
export const dialogButtonStyles = tv({
    ...
    compoundVariants: [
        ...
        { variant: "secondary", disabled: true, class: "bg-hyper-secondary-disabled" },
...
export const dialogButtonLabelStyles = tv({
    ...
    compoundVariants: [
        { variant: "secondary", disabled: true, class: "text-hyper-label-disabled" },
...
export type DialogButtonVariant = "primary" | "secondary" | "tonal" | "danger" | "text";
