    ...
    <View style={{ gap: 8 }}>
      ...
      {entity && (
        ...
        >
          <Text
            selectable
            style={{ fontSize: 14, color: semanticColors.textPrimary }}
          >
            {entity.body}
          </Text>
          <Text
            selectable
            style={{ fontSize: 13, color: semanticColors.textSecondary }}
          >
            ...
            优先级：
            {
              { low: "不重要", normal: "正常", high: "重要" }[entity.priority]
  ...
  return (
    <FormDialog
      ...
      actions={
        <View style={{ gap: 10 }}>
          ...
          {!deleted && (
            <AppButton
              label={record.deleted ? "保留本地删除并重试" : "保留本地并重试"}
              disabled={busy}
    ...
    >
      <ScrollView style={{ flexShrink: 1 }} contentContainerStyle={{ gap: 16 }}>
        <Text style={{ fontSize: 14, color: semanticColors.textSecondary }}>
        ...
        {!!error && (
          <Text
            ...
            style={{ fontSize: 14, color: semanticColors.destructive }}
          >
            {error}
          </Text>
        )}
