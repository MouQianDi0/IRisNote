        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <FieldError
                        message={form.errors.startTime ?? form.errors.endTime}
                    />
                    <View
                        style={{
                            marginTop: 12,
                        ...
                        <Host matchContents accessibilityLabel="开始时提醒">
                            <Switch
                                value={
                                    ...
                                    form.fields.reminderEnabled
                                }
                                disabled={form.busy || !form.fields.startTime}
                                onValueChange={(value) =>
                                    form.change("reminderEnabled", value)
                                }
                            />
                        </Host>
                    </View>
            ...
            {deleteTarget && (
                <DeleteConfirmDialog
                    ...
                    onConfirm={async () => {
                        assertTodoSession(todoRepository, ownerKey, generation);
                        try {
                            await todoRepository.delete(ownerKey, [
                                deleteTarget,
                            ]);
                            assertTodoSession(
                                todoRepository,
