                ...
                <View className="flex-1 items-center justify-center" style={{ backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
                    <TouchableWithoutFeedback>
                        <View className="bg-white p-5 rounded-[12px] shadow-md w-[300px]">
                            ...
                            <Text className="text-[18px] font-bold  mt-3">选择图标</Text>
                            <View className="-mb-3">
                            ...
                            <Pressable onPress={onDelete} className="mt-4 py-3 bg-red-50 rounded-[12px]">
                                <Text className="text-center text-[14px] font-bold text-red-500">删除</Text>
                            </Pressable>
                        </View>
                    </TouchableWithoutFeedback>
                </View>
