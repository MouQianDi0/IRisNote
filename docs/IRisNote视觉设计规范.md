...
- 验证码输入与发送按钮间隔 10dp；发送按钮宽 120dp、高 48dp、圆角 14dp、浅灰底蓝字。发送中原位显示加载状态，成功后 60 秒倒计时。
- 主按钮距表单 28dp，通栏、高 48dp、14dp 圆角、品牌蓝底白字，17sp 常规字重；使用显式 HyperOS 禁用 Token，按压透明度 0.85。
