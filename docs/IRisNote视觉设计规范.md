...
> 文档版本：1.11（2026-09-14：浮动编辑器工具栏圆角改为 16dp）
...
- 标签 14sp，距输入框 8dp；输入框高 48dp、16dp 圆角、左右内边距 16dp、正文 17sp、hyper-card 浅灰底。聚焦时 1dp 蓝边，错误时红边，错误文字位于框下 6dp、14sp。密码图标 20dp，触控区 48×48dp。
